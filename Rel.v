...
Proof.
  unfold partial_function. intros. inversion H. Qed.
...
Proof.
  ...
  intros n m o Hnm Hmo.
  induction o as [| o'].
  rewrite Hnm. rewrite <- Hmo. apply le_S. apply le_n.
  rewrite Hnm. rewrite <- Hmo. apply le_S. apply le_n.
Qed.
(** [] *)
...
Theorem le_S_n : forall n m,
  (S n <= S m) -> (n <= m).
Proof.
  intros. inversion H. apply le_n. apply le_Sn_le. apply H1.
Qed.
...
Proof.
  ...
  induction a.
  intros. destruct b. reflexivity. inversion H0.
  intros. destruct b. inversion H. apply f_equal. apply IHa.
...
Proof.
  ...
  induction H.
  intros. apply H0.
  intros. apply rsc_step with y.
  apply H.
  apply IHrefl_step_closure. apply H1.
Qed.
